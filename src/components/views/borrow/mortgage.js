				...
				<div className="columns">
			      	<div className="column">
			        	<div className="box no-padding">
			        		<table className="table is-narrow is-fullwidth mtg-table no-margin">
								<thead>
							    	<tr>
								      	<th>Debt type</th>
							  	...
							  	<tbody>
								    <tr>
									    <td>Home mortgage</td>
									    <td className="align-right">$470,000</td>
									    <td className="align-right">$1,750/<span className="gray-txt">month</span></td>
									    <td className="align-right">4.65<span className="gray-txt">%</span></td>
									    <td><Link to="/mortgage-info">Details</Link></td>
								    </tr>
								    <tr>
									    <td>Cottage mortgage</td>
									    <td className="align-right">$350,000</td>
									    <td className="align-right">$1,200/<span className="gray-txt">month</span></td>
									    <td className="align-right">4.15<span className="gray-txt">%</span></td>
									    <td><Link to="/mortgage-info">Details</Link></td>
								    </tr>
							  	</tbody>
							</table>
							<div className="col btn-sec pb-20 align-center">
