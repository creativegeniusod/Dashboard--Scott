...
class DashboardProtector14 extends React.Component {
  render() {
        return (
        		<div>
				              ...
				              <div className="full-width">                    
				                  ...
				                  <div className="col">
				                   <p className="no-margin heading">Put <strong>$114/month</strong> towards <strong>$700,000</strong> of insurance coverage.</p>
				                    ...
				                    <h4 className="no-margin pt-0 pb-10">Your critical illness policy has been underwritten and needs to approved!</h4>
				                  </div>
				              </div>
				            </div>
				        </article>
				        <div className="col btn-sec pt-10 pb-10">
	                  		<a className="button is-danger" onClick={this.props.protecttab}>Approve my policy</a>
	                  	</div>
		            </div>
		            <div className="box no-padding message-col dashboard detialed-box"> 
		              	<article className="message no-margin">
...
export default DashboardProtector14;
